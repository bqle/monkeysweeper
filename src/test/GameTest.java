...
public class GameTest {
    ...
    public void testCreation() {
        ...
        try {
            ...
            Assertions.assertTrue(minesweeper.getFlagCount() > 0);
            Assertions.assertEquals(minesweeper.getBombCount(), minesweeper.getFlagCount());
        } catch (Exception e) {
    ...
    public void testGetAdjacentBombLikeProCenter() {
        ...
        Assertions.assertEquals(1.0f / 8, minesweeper.getAdjacentBombProbabilityLikePro(board, 1, 1));
        board[1][1].setValue(4);
        Assertions.assertEquals(4.0f / 8, minesweeper.getAdjacentBombProbabilityLikePro(board, 1, 1));
        ...
        Assertions.assertEquals(1.0f, minesweeper.getAdjacentBombProbabilityLikePro(board, 1, 1));
    ...
    public void testGetAdjacentBombLikeProEdgeAndCorner() {
        ...
        Assertions.assertEquals(1.0f / 3, minesweeper.getAdjacentBombProbabilityLikePro(board, 0, 0));
        Assertions.assertEquals(1.0f / 5, minesweeper.getAdjacentBombProbabilityLikePro(board, 1, 0));
    }
    ...
    public void testSolveLikeMonkey() {
        ...
        for (int i = 0; i < 100; i++) {
            ...
            Assertions.assertTrue(minesweeper.isGameOver());
            Assertions.assertFalse(minesweeper.checkWin());
        }
    }
    ...
    public void testSolveLikeMonkeyNoBombShouldClickAllSquaresAndWin() {
        ...
        minesweeper.setBombCount(0);
        LinkedList<Square> ll = minesweeper.solveLikeMonkey();
        Assertions.assertEquals(ll.size(), 400);
        for (Square s : ll) {
            minesweeper.show(s.getI(), s.getJ());
        }
        Assertions.assertTrue(minesweeper.checkWin());
    }
